...
if [[ $# -lt 1 || -z "${1:-}" ]]; then
  ...
  echo "MODEL (opcjonalnie): gen7heur4"
  exit 1
fi
...
MANIFEST_IMPL_SHA256="${POKER44_MODEL_IMPLEMENTATION_SHA256:-f55e23c71abff45602f64e2cf73212f2688715f77a7b430f02aab6746263eb4a}"
...
case "$MODEL" in
  ...
  "gen7heur4" )
    ;;
  * )
    echo "ERROR: Niepoprawny MODEL='$MODEL'. Dozwolone: gen7heur4"
    exit 1
    ;;
esac
